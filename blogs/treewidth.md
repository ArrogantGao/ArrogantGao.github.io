+++
title = "Finding the Optimal Tree Decomposition with Minimal Treewidth"
hascode = true
date = Date(2024, 8, 15)
rss = "An introduction to TreeWidthSolver.jl, which can be used to solve tree decomposition with minimal treewidth of a given simple graph."
...
![](/assets/treewidth_figs/treedecomposition_square.png)
...
![](/assets/treewidth_figs/elimination_order.png)
...
In this section, I will introduce one of the most basic exact algorithms: the Bouchitté–Todinca (BT) algorithm[^Bouchitté][^BouchittéListing][^Tuukka], which makes use of the theory of minimal triangulations, characterizing the minimal triangulations of a graph via objects called minimal separators and potential maximal cliques of the graph.
...
![](/assets/treewidth_figs/triangulation.png)
...
![](/assets/treewidth_figs/sep_BC.png)
...
![](/assets/treewidth_figs/BT_algorithm.png)
...
<!-- ![](/assets/treewidth_figs/dynamic_programming.png) -->
